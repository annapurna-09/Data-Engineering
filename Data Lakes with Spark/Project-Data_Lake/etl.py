...
#     songs_table.write.mode('overwrite').partitionBy("year", "artist_id").parquet(output_data+'songs_table/')
    songs_table.write.mode('overwrite').partitionBy("year", "artist_id").parquet('data/output/songs_table/')
...
def process_log_data(spark, input_data, output_data):
    ...
    log_path = '/home/workspace/data/log-data/*.json'
...
#     time_table.write.mode('overwrite').partitionBy("year", "month").parquet(output_data+'time_table/')
    time_table.write.mode('overwrite').partitionBy("year", "month").parquet('data/output/time_table/')
    
    # read in song data to use for songplays table
#     song_df = spark.read.parquet(output_data+'songs_table/')
    song_df = spark.read.parquet('data/output/songs_table/')
...
#     songplays_table.write.mode('overwrite').partitionBy("year", "month").parquet(output_data+'songplays_table/')
    songplays_table.write.mode('overwrite').partitionBy("year", "month").parquet('data/output/songplays_table/')
